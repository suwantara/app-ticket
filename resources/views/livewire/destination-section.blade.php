<div>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4">
            ...
            <div class="justify-items-end mb-6">
                {{-- CTA Button --}}
                <div>
                    <a href="{{ route('destinations.index') }}"
                        class="inline-flex items-center gap-2 text-yellow-400 font-semibold hover:text-yellow-500 hover:underline transition-all duration-300 self-center md:self-auto">
            ...
            <div class="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide"
                ...
                @forelse($destinations as $destination)
                    ...
                    <div
                        ...
                        <p class="mb-4 text-body">{{ Str::limit(strip_tags($destination->description), 150) }}</p>
                        {{-- Action Button --}}
                        <a href="{{ route('destinations.show', $destination->slug) }}"
